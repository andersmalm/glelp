...
bool glelp::init_WGL_ARB_buffer_region()
{
	if(!glelp::checkAvailable("WGL_ARB_buffer_region")) return false;
...
bool glelp::init_WGL_ARB_create_context()
{
...
bool glelp::init_WGL_ARB_create_context_profile()
{
	if(!glelp::checkAvailable("WGL_ARB_create_context_profile")) return false;

	return true;
}

bool glelp::init_WGL_ARB_create_context_robustness()
{
	if(!glelp::checkAvailable("WGL_ARB_create_context_robustness")) return false;

	return true;
}

bool glelp::init_WGL_ARB_extensions_string()
{
	if(!glelp::checkAvailable("WGL_ARB_extensions_string")) return false;
	wglGetExtensionsStringARB = (PFNWGLGETEXTENSIONSSTRINGARBPROC)wglGetProcAddress("wglGetExtensionsStringARB");

	return true;
}

bool glelp::init_WGL_ARB_framebuffer_sRGB()
{
	if(!glelp::checkAvailable("WGL_ARB_framebuffer_sRGB")) return false;

	return true;
}

bool glelp::init_WGL_ARB_make_current_read()
{
	if(!glelp::checkAvailable("WGL_ARB_make_current_read")) return false;
...
bool glelp::init_WGL_ARB_multisample()
{
	if(!glelp::checkAvailable("WGL_ARB_multisample")) return false;

	return true;
}

bool glelp::init_WGL_ARB_pbuffer()
{
	if(!glelp::checkAvailable("WGL_ARB_pbuffer")) return false;
...
bool glelp::init_WGL_ARB_pixel_format()
{
...
bool glelp::init_WGL_ARB_pixel_format_float()
{
	if(!glelp::checkAvailable("WGL_ARB_pixel_format_float")) return false;

	return true;
}

bool glelp::init_WGL_ARB_render_texture()
{
	if(!glelp::checkAvailable("WGL_ARB_render_texture")) return false;
...
bool glelp::init_WGL_ARB_robustness_application_isolation()
{
	if(!glelp::checkAvailable("WGL_ARB_robustness_application_isolation")) return false;

	return true;
}

bool glelp::init_WGL_ARB_robustness_share_group_isolation()
{
	if(!glelp::checkAvailable("WGL_ARB_robustness_share_group_isolation")) return false;

	return true;
}

bool glelp::init_WGL_3DFX_multisample()
{
	if(!glelp::checkAvailable("WGL_3DFX_multisample")) return false;

	return true;
}

bool glelp::init_WGL_3DL_stereo_control()
{
	if(!glelp::checkAvailable("WGL_3DL_stereo_control")) return false;
	wglSetStereoEmitterState3DL = (PFNWGLSETSTEREOEMITTERSTATE3DLPROC)wglGetProcAddress("wglSetStereoEmitterState3DL");

	return true;
}

bool glelp::init_WGL_AMD_gpu_association()
{
	if(!glelp::checkAvailable("WGL_AMD_gpu_association")) return false;
...
bool glelp::init_WGL_ATI_pixel_format_float()
{
	if(!glelp::checkAvailable("WGL_ATI_pixel_format_float")) return false;

	return true;
}

bool glelp::init_WGL_EXT_create_context_es2_profile()
{
	if(!glelp::checkAvailable("WGL_EXT_create_context_es2_profile")) return false;

	return true;
}

bool glelp::init_WGL_EXT_create_context_es_profile()
{
	if(!glelp::checkAvailable("WGL_EXT_create_context_es_profile")) return false;

	return true;
}

bool glelp::init_WGL_EXT_depth_float()
{
	if(!glelp::checkAvailable("WGL_EXT_depth_float")) return false;

	return true;
}

bool glelp::init_WGL_EXT_display_color_table()
{
	if(!glelp::checkAvailable("WGL_EXT_display_color_table")) return false;
...
bool glelp::init_WGL_EXT_extensions_string()
{
	if(!glelp::checkAvailable("WGL_EXT_extensions_string")) return false;
	wglGetExtensionsStringEXT = (PFNWGLGETEXTENSIONSSTRINGEXTPROC)wglGetProcAddress("wglGetExtensionsStringEXT");

	return true;
}

bool glelp::init_WGL_EXT_framebuffer_sRGB()
{
	if(!glelp::checkAvailable("WGL_EXT_framebuffer_sRGB")) return false;

	return true;
}

bool glelp::init_WGL_EXT_make_current_read()
{
	if(!glelp::checkAvailable("WGL_EXT_make_current_read")) return false;
...
bool glelp::init_WGL_EXT_multisample()
{
	if(!glelp::checkAvailable("WGL_EXT_multisample")) return false;

	return true;
}

bool glelp::init_WGL_EXT_pbuffer()
{
	if(!glelp::checkAvailable("WGL_EXT_pbuffer")) return false;
...
bool glelp::init_WGL_EXT_pixel_format()
{
	if(!glelp::checkAvailable("WGL_EXT_pixel_format")) return false;
...
bool glelp::init_WGL_EXT_pixel_format_packed_float()
{
	if(!glelp::checkAvailable("WGL_EXT_pixel_format_packed_float")) return false;

	return true;
}

bool glelp::init_WGL_EXT_swap_control()
{
	if(!glelp::checkAvailable("WGL_EXT_swap_control")) return false;
...
bool glelp::init_WGL_EXT_swap_control_tear()
{
	if(!glelp::checkAvailable("WGL_EXT_swap_control_tear")) return false;

	return true;
}

bool glelp::init_WGL_I3D_digital_video_control()
{
	if(!glelp::checkAvailable("WGL_I3D_digital_video_control")) return false;
...
bool glelp::init_WGL_I3D_gamma()
{
	if(!glelp::checkAvailable("WGL_I3D_gamma")) return false;
...
bool glelp::init_WGL_I3D_genlock()
{
	if(!glelp::checkAvailable("WGL_I3D_genlock")) return false;
...
bool glelp::init_WGL_I3D_image_buffer()
{
	if(!glelp::checkAvailable("WGL_I3D_image_buffer")) return false;
...
bool glelp::init_WGL_I3D_swap_frame_lock()
{
	if(!glelp::checkAvailable("WGL_I3D_swap_frame_lock")) return false;
...
bool glelp::init_WGL_I3D_swap_frame_usage()
{
	if(!glelp::checkAvailable("WGL_I3D_swap_frame_usage")) return false;
...
bool glelp::init_WGL_NV_DX_interop()
{
	if(!glelp::checkAvailable("WGL_NV_DX_interop")) return false;
...
bool glelp::init_WGL_NV_DX_interop2()
{
	if(!glelp::checkAvailable("WGL_NV_DX_interop2")) return false;

	return true;
}

bool glelp::init_WGL_NV_copy_image()
{
	if(!glelp::checkAvailable("WGL_NV_copy_image")) return false;
	wglCopyImageSubDataNV = (PFNWGLCOPYIMAGESUBDATANVPROC)wglGetProcAddress("wglCopyImageSubDataNV");

	return true;
}

bool glelp::init_WGL_NV_delay_before_swap()
{
	if(!glelp::checkAvailable("WGL_NV_delay_before_swap")) return false;
	wglDelayBeforeSwapNV = (PFNWGLDELAYBEFORESWAPNVPROC)wglGetProcAddress("wglDelayBeforeSwapNV");

	return true;
}

bool glelp::init_WGL_NV_float_buffer()
{
	if(!glelp::checkAvailable("WGL_NV_float_buffer")) return false;

	return true;
}

bool glelp::init_WGL_NV_gpu_affinity()
{
	if(!glelp::checkAvailable("WGL_NV_gpu_affinity")) return false;
...
bool glelp::init_WGL_NV_multisample_coverage()
{
	if(!glelp::checkAvailable("WGL_NV_multisample_coverage")) return false;

	return true;
}

bool glelp::init_WGL_NV_present_video()
{
	if(!glelp::checkAvailable("WGL_NV_present_video")) return false;
...
bool glelp::init_WGL_NV_render_depth_texture()
{
	if(!glelp::checkAvailable("WGL_NV_render_depth_texture")) return false;

	return true;
}

bool glelp::init_WGL_NV_render_texture_rectangle()
{
	if(!glelp::checkAvailable("WGL_NV_render_texture_rectangle")) return false;

	return true;
}

bool glelp::init_WGL_NV_swap_group()
{
	if(!glelp::checkAvailable("WGL_NV_swap_group")) return false;
...
bool glelp::init_WGL_NV_vertex_array_range()
{
	if(!glelp::checkAvailable("WGL_NV_vertex_array_range")) return false;
...
bool glelp::init_WGL_NV_video_capture()
{
	if(!glelp::checkAvailable("WGL_NV_video_capture")) return false;
...
bool glelp::init_WGL_NV_video_output()
{
	if(!glelp::checkAvailable("WGL_NV_video_output")) return false;
...
bool glelp::init_WGL_OML_sync_control()
{
	if(!glelp::checkAvailable("WGL_OML_sync_control")) return false;
